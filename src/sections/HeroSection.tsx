        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          <div className="lg:col-span-8">
            <div className="inline-flex items-center gap-2 bg-blue-600/20 border border-blue-500/30 rounded-full px-4 py-1.5 mb-6 backdrop-blur-sm">
              ...
              <span className="text-blue-100 text-sm font-medium">Design &amp; Build Home Improvements</span>
            </div>

            <h1 className="text-3xl lg:text-5xl font-bold text-white leading-tight mb-6">
              Convert Extend: house extensions, loft conversions, and full renovations —
              <span className="text-blue-500"> designed &amp; built properly.</span>
            </h1>

            <p className="text-lg text-slate-300 mb-8 leading-relaxed max-w-xl">
              We manage the full process: design, planning support, structural work, build, and
              finishing. Clear quotes, tidy sites, and communication you don’t have to chase.
            </p>
            ...
            <div className="flex items-center gap-8 pt-8 border-t border-slate-700/50">
              <div className="flex flex-col max-w-[200px]">
                <p className="text-slate-200 italic text-sm mb-2">
                  {"Great team. Clear quote, tidy site, and the finish is spot on."}
                </p>
